...
We present [CaMol](https://github.com/NSLab-CUK/CaMol), a novel architecture for predicting molecular property in few-shot scenarios and developed by NS Lab, CUK based on pure PyTorch backend.
